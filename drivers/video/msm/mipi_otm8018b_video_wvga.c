...
/* delete otm8018b_chimei_lcd_on_table table */
static const struct sequence otm8018b_chimei_lcd_init_table[] =
{
	{0x00000,MIPI_DCS_COMMAND,0},//address FF00h  set password
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address FF80h
	{0x00080,TYPE_PARAMETER,0},
	{0x000FF,MIPI_GEN_COMMAND,0},
	{0x00080,TYPE_PARAMETER,0},
	{0x00009,TYPE_PARAMETER,1},

	{0x00000,MIPI_DCS_COMMAND,0},//address C0B4h 
	{0x000B4,TYPE_PARAMETER,0},
	{0x000C0,MIPI_GEN_COMMAND,0},
	{0x00055,TYPE_PARAMETER,0},//00h=>1 dot inversion 11h=>2 dot inversion 55h=>column inversion

	{0x00000,MIPI_DCS_COMMAND,0},// address C0b5h lcd mirror
	{0x000B5,TYPE_PARAMETER,0},
	{0x000C0,MIPI_GEN_COMMAND,0},
	{0x00008,TYPE_PARAMETER,0},

	{0x00000,MIPI_DCS_COMMAND,0},//address C590h Power control setting 2 for normal mode
	{0x00090,TYPE_PARAMETER,0},
	{0x000C5,MIPI_GEN_COMMAND,0},
	{0x000D6,TYPE_PARAMETER,0},
	{0x00076,TYPE_PARAMETER,0},

	{0x00000,MIPI_DCS_COMMAND,0},//address C582h  REG-Pump23 AVEE VCL
	{0x00082,TYPE_PARAMETER,0},
	{0x000C5,MIPI_GEN_COMMAND,0},
	{0x000A3,TYPE_PARAMETER,0},

	{0x00000,MIPI_DCS_COMMAND,0},//address D800h Set  GVDD/NGVDD 5.3V
	{0x00000,TYPE_PARAMETER,0},
	{0x000D8,MIPI_GEN_COMMAND,0},
	{0x000AF,TYPE_PARAMETER,0},
	{0x000AF,TYPE_PARAMETER,0},

//	{0x00000,MIPI_DCS_COMMAND,0},//address D900h VCOM Voltage setti.-1.9500V
//	{0x00000,TYPE_PARAMETER,0},
//	{0x000D9,MIPI_GEN_COMMAND,0},
//	{0x00085,TYPE_PARAMETER,0},

	{0x00000,MIPI_DCS_COMMAND,0},//address C592h
	{0x00092,TYPE_PARAMETER,0},
	{0x000C5,MIPI_GEN_COMMAND,0},
	{0x00001,TYPE_PARAMETER,0},

	{0x00000,MIPI_DCS_COMMAND,0},//address C5B1h
	{0x000B1,TYPE_PARAMETER,0},
	{0x000C5,MIPI_GEN_COMMAND,0},
	{0x000A9,TYPE_PARAMETER,0},
	
	{0x00000, MIPI_DCS_COMMAND,0},//address 0xC6Bxh set LCD_backlight PWM frequency
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address C09xh : mck_shift1/mck_shift2/mck_shift3
	{0x00090,TYPE_PARAMETER,0},
	{0x000C0,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	...
	/* enable external clk hs & vs signal reference */
	{0x00000,MIPI_DCS_COMMAND,0},//address C1Axh : oscilator
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address C1Axh : hs_shift/vs_shift
	{0x000A6,TYPE_PARAMETER,0},
	{0x000C1,MIPI_GEN_COMMAND,0},
	{0x00001,TYPE_PARAMETER,0},
	{0x00000,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0}, //ensure read id correctly
	{0x000C6,TYPE_PARAMETER,0},
	{0x000B0,MIPI_GEN_COMMAND,0},
	{0x00003,TYPE_PARAMETER,0},
	//fix flash end
	
	{0x00000,MIPI_DCS_COMMAND,0},//address CE8xh : vst1, vst2, vst3, vst4
	{0x00080,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CE9xh
	{0x00090,TYPE_PARAMETER,0},
	{0x000CE,MIPI_GEN_COMMAND,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CEAxh : clka1, clka2
	{0x000A0,TYPE_PARAMETER,0},
	{0x000CE,MIPI_GEN_COMMAND,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CEBxh : clka3, clka4
	{0x000B0,TYPE_PARAMETER,0},
	{0x000CE,MIPI_GEN_COMMAND,0},
	{0x00038,TYPE_PARAMETER,0},
	{0x00001,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CEcxh : clkb1, clkb2
	{0x000C0,TYPE_PARAMETER,0},
	{0x000CE,MIPI_GEN_COMMAND,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//addressCEdxh : clkb3, clkb4
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CFCxh
	{0x000C7,TYPE_PARAMETER,0},
	{0x000CF,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0}, //00h GOA falling precharge  80h GOA rise and falling precharge

	{0x00000,MIPI_DCS_COMMAND,0},//address CBCxh //For power off sequence  //GOA timing delay 2 frame OFF
	{0x000C0,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CBD0h //For power off sequence  //GOA timing delay 2 frame OFF
	{0x000D0,TYPE_PARAMETER,0},
	{0x000CB,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	{0x00000,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CBExh //For power off sequence  //GOA timing delay 2 frame OFF
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CC8xh 
	{0x00080,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0}, //address CC9xh 
	{0x00090,TYPE_PARAMETER,0},
	{0x000CC,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CCAxh
	{0x000A0,TYPE_PARAMETER,0},
	{0x000CC,MIPI_GEN_COMMAND,0},
	{0x00009,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CCBxh
	{0x000B0,TYPE_PARAMETER,0},
	{0x000CC,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	{0x00000,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CCCxh
	{0x000C0,TYPE_PARAMETER,0},
	{0x000CC,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	{0x00001,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address CCDxh
	{0x000D0,TYPE_PARAMETER,0},
	{0x000CC,MIPI_GEN_COMMAND,0},
	{0x00010,TYPE_PARAMETER,0},
	{0x0000A,TYPE_PARAMETER,0},
	...
	/*add new GAMMA 2.5 parameter */
	{0x00000,MIPI_DCS_COMMAND,0},//GAMMA 2.5+
	{0x00000,TYPE_PARAMETER,0},
	...
	{0x00000,MIPI_DCS_COMMAND,0},//address FF00h
	{0x00000,TYPE_PARAMETER,0},
	{0x000FF,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	{0x00000,TYPE_PARAMETER,0},
